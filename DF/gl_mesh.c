...
void GL_MakeAliasModelDisplayLists (model_t *m, aliashdr_t *hdr)
{
	...
	// I really don't get FitzQuake's aversion to using basic hardware features.  The texture matrix was available in GL1.1 but yet we got this crap instead.
#ifndef NO_MIPMAPPING_LOOKS_BAD
