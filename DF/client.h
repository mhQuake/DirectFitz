...
#ifdef EXTRA_DLIGHTS
// MH - stock FitzQuake just bumped this define but didn't expand the dlightbits arrays
#define	MAX_DLIGHTS		64 //johnfitz -- was 32

// keeping dlight colours in the one place so that if i need to change them i only need to do it once
...
#else
#define	MAX_DLIGHTS		32 //johnfitz -- was 32
#endif
