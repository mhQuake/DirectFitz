...
void R_EmitWireBox (vec3_t mins, vec3_t maxs)
{
	...
	glVertex3f (mins[0], mins[1], mins[2]);	// 0
	glVertex3f (mins[0], mins[1], maxs[2]);	// 1
	glVertex3f (maxs[0], mins[1], mins[2]);	// 2
	glVertex3f (maxs[0], mins[1], maxs[2]);	// 3
	glVertex3f (maxs[0], maxs[1], mins[2]);	// 4
	glVertex3f (maxs[0], maxs[1], maxs[2]);	// 5
	glVertex3f (mins[0], maxs[1], mins[2]);	// 6
	glVertex3f (mins[0], maxs[1], maxs[2]);	// 7
	glVertex3f (mins[0], mins[1], mins[2]);	// 8
	glVertex3f (mins[0], mins[1], maxs[2]);	// 9
	glEnd ();
}
