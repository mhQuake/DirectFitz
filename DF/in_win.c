...
// mh - prevent DIRECTINPUT_VERSION undefined. Defaulting to version 0x0800
// original Quake used DX3 so we keep the DX3 interfaces
#define DIRECTINPUT_VERSION 0x0300

// enable mouse wheel support via dinput
