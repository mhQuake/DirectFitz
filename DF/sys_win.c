...
#ifdef _DEBUG
	char debugCmdLine[256];

	//strcpy (debugCmdLine, "-width 800 -height 480 -window -heapsize 64000 -txgamma 0.7");
	strcpy (debugCmdLine, "-width 1024 -height 600 -window -heapsize 64000 -txgamma 0.7");
	//strcpy (debugCmdLine, "-width 1024 -height 768 -window -heapsize 64000 -txgamma 0.7");
	//strcpy (debugCmdLine, "-width 1366 -height 768 -heapsize 64000 -txgamma 0.7");
	//strcpy (debugCmdLine, "-width 1440 -height 900 -heapsize 64000 -txgamma 0.7");
	//strcpy (debugCmdLine, "-width 1920 -height 1080 -heapsize 64000 -txgamma 0.7");
...
#ifndef DIRECT3D9_WRAPPER //johnfitz -- 0 to supress the 'starting quake' dialog
	if (!isDedicated)
	{
