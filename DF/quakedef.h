...
#define TRUE_LIGHTPOINT
#define STENCIL_SHADOWS
#define TEXTURE_NPO2
#define SHADOW_VOLUMES
#define COLOR_255_IS_NOT_FULLBRIGHT
#define FITZQUAKE_SKY_GIVES_ME_FITS
#define ALLOW_MODS_IF_UNREGISTERED
#define SHADER_BASED_GAMMA
#define GUNTER_SUCKS_DONKEY_BALLS
#define MOD_LOAD_LIGHTING_IS_INSANE
#define RGB_2X_IS_NOT_ENOUGH
#define NO_MIPMAPPING_LOOKS_BAD

// correct a few things in the view code where host_frametime is used but which is invalid if the client in running at a different speed
// substitute (cl.time - cl.oldtime) so that the actual client frametime is used instead
